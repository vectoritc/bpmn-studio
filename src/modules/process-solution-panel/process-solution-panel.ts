  ...
  private _newDiagramNameValidator: FluentRuleCustomizer<IViewModelSolution, IViewModelSolution> = ValidationRules
      ...
      .satisfies((input: string) => {
        const regExpList: any = {
          ...
          kurdish: /^[çêîşû]+$/i,
          romanian: /^[ăîâşţ]+$/i,
          welsish: /^[óúẃýàèìòùẁỳäëöüẅÿâêîôûŵŷáéíï]+$/i,
          esperanto: /^[ĉĝĥĵŝŭ]+$/i,
          turkish: /^[ğçıöşü]+$/i,
          icelandic: /^[áðéíóúýþæö]+$/i,
          hungarian: /^[áéíóöőúüű]+$/i,
          catalan: /^[àçéèíóòúüï]+$/i,
          french: /^[àâçéèêëîïôœùûüÿ]+$/i,
          occitan: /^[áàçéèíóòúëüï·]+$/i,
          portugese: /^[ãõçáéíóúâêôàü]+$/i,
          spanish: /^[áéíñóúü]+$/i,
          italian: /^[àéèìòù]+$/i,
          guarani: /^[áéíóúýãẽĩõũỹñg̃]+$/i,
          southernAthabaskan: /^[áąą́éęę́íįį́łń]+$/i,
          westernApache: /^[āą̄ēę̄īį̄óōǫǫ́ǭúū]+$/i,
          navajo: /^['óǫǫ́]+$/i,
          chiricahua: /^[’úųų́]+$/i,
          polish: /^[ąłńóżćęśź]+$/i,
          silesian: /^[ąłńóżćśůź]+$/i,
          kashubian: /^[ąłńóżãéëòôù]+$/i,
          slovene: /^[čšž]+$/i,
          croatia: /^[čšžćđ]+$/i,
          czech: /^[čšžáďéěňóřťúůý]+$/i,
          slovak: /^[čšžáäďéíľĺňóôŕťúý]+$/i,
          latvian: /^[čšžāēģīķļņōŗū]+$/i,
          lithuanian: /^[ąęėįųūčšž]+$/i,
          vietnamese: /^[đàảãáạăằẳẵắặâầẩẫấậèẻẽéẹêềểễếệìỉĩíịòỏõóọồổỗốơờởỡớợùủũúụưừửữứựỳỷỹýỵ]+$/i,
